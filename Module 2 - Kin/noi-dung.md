...
- Nhóm **Giao diện** có 6 ca cho mỗi màn hình, nhóm **Chức năng** có 2 ca cho mỗi màn hình (có dữ liệu + không có dữ liệu). Nhóm **Luồng nghiệp vụ** gồm 6 ca end-to-end phủ đủ các ràng buộc của đặc tả (5a, 5b, 9a, 9b, 9c) và yêu cầu sắp xếp theo alphabet.
