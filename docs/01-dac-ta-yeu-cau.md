...
| **Nhân viên** | Ký hợp đồng tay đua (M1), đăng ký tay đua vào chặng (M2), cập nhật kết quả chặng (M3); quản lý danh mục tay đua/đội/chặng |
...
- FR2.2 Ký hợp đồng mới: chọn đội, nhập ngày bắt đầu/kết thúc.
- FR2.3 **Ràng buộc:** tại một thời điểm tay đua chỉ thuộc 1 đội — khoảng thời gian hợp đồng mới không được chồng lấn hợp đồng cũ.
- FR2.4 Lưu và in hợp đồng.

### FR3 — Đăng ký tay đua tham gia chặng đua (Module 2)
- FR3.1 Chọn chặng đua và đội đua.
- FR3.2 Hiển thị danh sách tay đua đang có hợp đồng hiệu lực với đội tại thời điểm chặng.
