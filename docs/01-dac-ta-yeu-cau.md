...
> Bốn chức năng nghiệp vụ chính ở mục 3.8 – 3.11 chính là **4 module được phân công** cho bốn thành viên; nguồn gốc là đề bài [../project10-F1-4modules.md](../project10-F1-4modules.md). Yêu cầu chức năng tương ứng được hệ thống hóa ở mục 7 (FR2 – FR5) của tài liệu này.
